...
def update_flash_attention(config: dict, model: str):
    ...
    if any(keyword in model.lower() for keyword in {"llama-2","llama-3","llama2","llama3", "mistral", "gemma", "pythia", "gpt", "falcon", "phi", "qwen", "deepseek","neural","vikhr","solar","yi","vicuna"}):
